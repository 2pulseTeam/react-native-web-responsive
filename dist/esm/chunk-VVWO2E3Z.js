...
var components_default = {
  ...
  Modal: withResponsive(Modal),
  Image: withResponsive(Image),
  Switch: withResponsive(Switch),
  TextInput: withResponsive(TextInput),
  SafeAreaView: withResponsive(SafeAreaView),
  ScrollView: withResponsive(ScrollView),
  ImageBackground: withResponsive(ImageBackground),
