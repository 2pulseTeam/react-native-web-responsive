...
import { StyleProp, ViewProps, useWindowDimensions, StyleSheet, PressableStateCallbackType } from 'react-native';
...
//((state: PressableStateCallbackType) => StyleProp<S>)
export const withResponsive = <S extends NativeStyle, P>(Component: ComponentType<{ style?: StyleProp<S> }>) => {
